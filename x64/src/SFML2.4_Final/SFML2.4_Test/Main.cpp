...
void initShapes(sf::RenderWindow& window, vector<Lane>& laneList, CarList& carList, Lane& junction)
{
	...
	//carList.addItem(Lane::LaneWI, Lane::LaneEO, sf::Color::Blue, Vector2f(20 + CAR_RADIUS, ((float)window.getSize().y - TRACK_WIDTH) / 2), Vector2f(1.f, 0));
	//carList.addItem(Lane::LaneWI, Lane::LaneEO, Car::getRandColor(), Vector2f(150 + CAR_RADIUS, ((float)window.getSize().y - TRACK_WIDTH) / 2), Vector2f(1.f, 0));

	//carList.addItem(Lane::LaneEI, Lane::LaneWO, Car::getRandColor(), Vector2f(((float)window.getSize().x + TRACK_WIDTH) / 2 + 300, ((float)window.getSize().y + TRACK_WIDTH) / 2), Vector2f(-0.5f, 0));
	//carList.addItem(Lane::LaneEI, Lane::LaneWO, sf::Color::Green, Vector2f(((float)window.getSize().x + TRACK_WIDTH) / 2 + 50, ((float)window.getSize().y + TRACK_WIDTH) / 2), Vector2f(-0.5f, 0));
	
	//carList.addItem(Lane::LaneNO, Lane::LaneNO, Car::getRandColor(), Vector2f(((float)window.getSize().x - TRACK_WIDTH) / 2, -250 + window.getSize().y / 2), Vector2f(0, -0.3f));
